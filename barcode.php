...
<body>
     <!-- logo dan Judul -->
     <header>
        <img src="aset boba/Judul.png" width="150px" id="Bobaandtea" alt="">
        <img src="aset boba/logo.png" width="100px" id="ayam" alt="">
    </header>
    
    <div id="barcode">
        <img height="400px" src="aset boba/barcode.jpg" alt="">
    </div>
